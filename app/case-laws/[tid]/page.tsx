...
const router = useRouter();
  ...
  const extractCaseInfo = (htmlContent: string) => {
    ...
    if (preElements.length > 0) {
      ...
      const pronouncementMatch = firstPre.match(/Date of Pronouncement\s*:\s*([0-9\/]+)/i);
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">{caseData.data.numcites}</div>
              <div className="text-sm text-gray-600">Citations</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{caseData.data.numcitedby}</div>
              <div className="text-sm text-gray-600">Cited By</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">{caseInfo.assessmentYear || 'N/A'}</div>
              <div className="text-sm text-gray-600">Assessment Year</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">{caseInfo.caseNumber || 'N/A'}</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-3">
                  <div>
                    <span className="text-sm font-medium text-gray-500">Parties:</span>
                    <p className="text-sm text-gray-900">{caseInfo.parties || 'Not specified'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Assessment Year:</span>
                    <p className="text-sm text-gray-900">{caseInfo.assessmentYear || 'Not specified'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Case Number:</span>
                    <p className="text-sm text-gray-900">{caseInfo.caseNumber || 'Not specified'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{formatDate(caseData.data.publishdate)}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Hearing Date:</span>
                    <p className="text-sm text-gray-900">{caseInfo.hearingDate || 'Not specified'}</p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-500">Pronouncement:</span>
                    <p className="text-sm text-gray-900">{caseInfo.pronouncementDate || 'Not specified'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm font-medium text-gray-500">Total Citations:</span>
                    <span className="text-sm font-bold text-blue-600">{caseData.data.numcites}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm font-medium text-gray-500">Cited By Others:</span>
                    <span className="text-sm font-bold text-green-600">{caseData.data.numcitedby}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm font-medium text-gray-500">Court Copy:</span>
                    <span className={`text-sm font-bold ${caseData.data.courtcopy ? 'text-green-600' : 'text-gray-400'}`}>
            ...
            {/* Source Information */}
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Source & Classification</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <span className="text-sm font-medium text-gray-500">Document Source:</span>
                  <p className="text-sm text-gray-900 mt-1">{caseData.data.docsource}</p>
                </div>
                <div>
                  <span className="text-sm font-medium text-gray-500">Document Type:</span>
                  <p className="text-sm text-gray-900 mt-1 capitalize">{caseData.data.divtype}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'details' && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Case Details Summary</h3>
        ...
        {activeTab === 'judgment' && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-6">Full Judgment Text</h3>
              <div 
